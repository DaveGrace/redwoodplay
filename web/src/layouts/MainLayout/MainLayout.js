...
import header from './broulee island.jpg'
...
const MainLayout = ({ children }) => {
 ...
 <img className="h-10 w-full" src={header} alt= "header"></img>
    ...
    <div className="relative flex justify-between h-15">
      ...
      <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        <div className="flex-shrink-0 flex items-center">
          ...
          src={logo} alt="Workflow logo"></img>
          <img className="hidden lg:block h-8 w-auto"
         src={logo} alt="Workflow "></img>
        </div>
        <div className="hidden sm:ml-6 sm:flex">
          ...
          <a href="#" className="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-blue-500 hover:text-gray-700 hover:border-blue-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
          <Link to={routes.about()}>About</Link>
          </a>
          <a href="#" className="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-blue-700 focus:border-gray-300 transition duration-150 ease-in-out">
            Projects
          </a>
